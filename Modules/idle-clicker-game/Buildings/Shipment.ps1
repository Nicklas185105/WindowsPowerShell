...
$global:BuildingData.Shipment.Upgrades.Plain = [UpgradeDefinition]::new(
    "Vanilla nebulae",
    1, # Own 1 shipment
    [Number]::new("51000000000"), # Base price: 51 billion
...
$global:BuildingData.Shipment.Upgrades.Berrylium = [UpgradeDefinition]::new(
    "Wormholes",
    5, # Own 5 shipments
    [Number]::new("255000000000"), # Base price: 255 billion
    "Shipments are twice as efficient.",
    20,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Blueberrylium = [UpgradeDefinition]::new(
    "Frequent flyer",
    25, # Own 25 shipments
    [Number]::new("2550000000000"), # Base price: 2.55 trillion
    "Shipments are twice as efficient.",
    21,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Chalcedhoney = [UpgradeDefinition]::new(
    "Warp drive",
    50, # Own 50 shipments
    [Number]::new("255000000000000"), # Base price: 255 trillion
    "Shipments are twice as efficient.",
    48,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Buttergold = [UpgradeDefinition]::new(
    ...
    [Number]::new("25500000000000000"), # Base price: 25.5 quadrillion
    "Shipments are twice as efficient.",
    114,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Sugarmuck = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000"), # Base price: 2.55 quintillion
    "Shipments are twice as efficient.",
    196,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Jetmint = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000000"), # Base price: 2.55 sextillion
    "Shipments are twice as efficient.",
    301,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Cherrysilver = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000000000"), # Base price: 2.55 septillion
    "Shipments are twice as efficient.",
    314,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Hazelrald = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000000000000"), # Base price: 2.55 octillion
    "Shipments are twice as efficient.",
    435,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Mooncandy = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000000000000000"), # Base price: 2.55 nonillion
    "Shipments are twice as efficient.",
    487,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Astrofudge = [UpgradeDefinition]::new(
    ...
    [Number]::new("25500000000000000000000000000000000"), # Base price: 25.5 decillion
    "Shipments are twice as efficient.",
    513,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Alabascream = [UpgradeDefinition]::new(
    ...
    [Number]::new("255000000000000000000000000000000000000"), # Base price: 255 undecillion
    "Shipments are twice as efficient.",
    669,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Iridyum = [UpgradeDefinition]::new(
    ...
    [Number]::new("2550000000000000000000000000000000000000000"), # Base price: 2.55 tredecillion
    "Shipments are twice as efficient.",
    707,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Glucosmium = [UpgradeDefinition]::new(
    ...
    [Number]::new("25500000000000000000000000000000000000000000000"), # Base price: 25.5 quattuordecillion
    "Shipments are twice as efficient.",
    750,
    { param($building) $building.Income *= [Number]::new("2") }
)
...
$global:BuildingData.Shipment.Upgrades.Glimmeringue = [UpgradeDefinition]::new(
    ...
    [Number]::new("255000000000000000000000000000000000000000000000000"), # Base price: 255 quindecillion
    "Shipments are twice as efficient.",
    847,
    { param($building) $building.Income *= [Number]::new("2") }
)