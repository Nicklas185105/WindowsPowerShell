...
class BuildingData {
    ...
    BuildingData(){
        $this.Cursor              = [BuildingDefinition]::new("Cursor",               15,                          0.1, $global:Keys.D1)
        $this.Grandma             = [BuildingDefinition]::new("Grandma",              100,                         1, $global:Keys.D2)
        $this.Farm                = [BuildingDefinition]::new("Farm",                 1100,                        8, $global:Keys.D3)
        $this.Mine                = [BuildingDefinition]::new("Mine",                 12000,                       47, $global:Keys.D4)
        $this.Factory             = [BuildingDefinition]::new("Factory",              130000,                      260, $global:Keys.D5)
        $this.Bank                = [BuildingDefinition]::new("Bank",                 1400000,                     1400, $global:Keys.D6)
        $this.Temple              = [BuildingDefinition]::new("Temple",               20000000,                    7800, $global:Keys.D7)
        $this.WizardTower         = [BuildingDefinition]::new("Wizard Tower",         330000000,                   44000, $global:Keys.D8)
        $this.Shipment            = [BuildingDefinition]::new("Shipment",             5100000000,                  260000, $global:Keys.D9)
        $this.AlchemyLab          = [BuildingDefinition]::new("Alchemy Lab",          75000000000,                 1600000, $global:Keys.D0)
        $this.Portal              = [BuildingDefinition]::new("Portal",               1000000000000,               10000000, $global:Keys.N1)
        $this.TimeMachine         = [BuildingDefinition]::new("Time Machine",         14000000000000,              65000000, $global:Keys.N2)
        $this.AntimatterCondenser = [BuildingDefinition]::new("Antimatter Condenser", 170000000000000,             430000000, $global:Keys.N3)
        $this.Prism               = [BuildingDefinition]::new("Prism",                2100000000000000,            2900000000, $global:Keys.N4)
        $this.Chancemaker         = [BuildingDefinition]::new("Chancemaker",          26000000000000000,           21000000000, $global:Keys.N5)
        $this.FractalEngine       = [BuildingDefinition]::new("Fractal Engine",       310000000000000000,          150000000000, $global:Keys.N6)
        $this.JavascriptConsole   = [BuildingDefinition]::new("Javascript Console",   71000000000000000000,        1100000000000, $global:Keys.N7)
        $this.Idleverse           = [BuildingDefinition]::new("Idleverse",            12000000000000000000000,     8300000000000, $global:Keys.N8)
        $this.CortexBaker         = [BuildingDefinition]::new("Cortex Baker",         1900000000000000000000000,   64000000000000, $global:Keys.N9)
        $this.You                 = [BuildingDefinition]::new("You",                  540000000000000000000000000, 510000000000000, $global:Keys.N0)
    }
